...
export function ClinicListItem({ clinic, isSelected, onSelect }: Props) {
    ...
    <div
      ...
      className={cn(
        ...
        isSelected
          ...
          : "border-border-default hover:border-brand/20 bg-bg-base hover:bg-brand/5",
    ...
    >
        ...
        <div className="flex items-center gap-1">
          <div
            className={cn(
              ...
              clinic.isActive ? "bg-emerald-500" : "bg-zinc-400"
            )}
          />
          <span
            className={cn(
      ...
      <div className="mt-2 h-1 bg-bg-subtle rounded-full overflow-hidden">
        <div
          ...
          style={{
            width: `${Math.min(
              (activeDoctors / clinic.maxDoctors) * 100,
              100
            )}%`,
          }}
        />
