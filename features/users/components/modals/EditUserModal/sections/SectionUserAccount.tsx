...
export function SectionUserAccount({ register, errors, control }: Props) {
  ...
  return (
    <div className="space-y-5">
      {/* Datos personales */}
      <div>
        <p className="text-[11px] font-bold text-text-secondary uppercase tracking-wider mb-3">Datos personales</p>
      ...
      {canEditOtherProfiles && (
        <>
          <div>
            <p className="text-[11px] font-bold text-text-secondary uppercase tracking-wider mb-3">Rol y estado</p>
            <Controller
              control={control}
              name="role"
              render={({ field }) => (
                    ...
                    return (
                      <button
                        ...
                        className={cn(
                          ...
                          isActive
                            ? cn(config.badge, "ring-1 ring-current shadow-sm border-transparent")
          ...
          <Controller
            ...
            name="isActive"
            render={({ field }) => (
              <div className="flex items-center justify-between p-3 rounded-xl border border-border-default bg-bg-subtle">
                <div>
                  <p className="text-sm font-medium text-text-primary">Estado de la cuenta</p>
