...
export function SectionDoctorProfile({ register, errors }: Props) {
  return (
    <div className="space-y-5">
      {/* Datos profesionales */}
      <div>
        <p className="text-[11px] font-bold text-text-secondary uppercase tracking-wider mb-3">Datos profesionales</p>
      ...
      {/* Dirección */}
      <div>
        <p className="text-[11px] font-bold text-text-secondary uppercase tracking-wider mb-3">Dirección personal</p>
        <div className="grid grid-cols-2 gap-4">
          <div className="col-span-2">
