  ...
  return (
    <div className="space-y-5 animate-in fade-in slide-in-from-right-5">
      ...
      <div className="grid grid-cols-2 gap-4">
        ...
        <Input label="Segundo nombre" icon={User} error={errors.middleName?.message} {...register("middleName")} />
      ...
      <div className="grid grid-cols-2 gap-4">
        <div className="col-span-2">
          <Input label="Email institucional *" type="email" icon={Mail} error={errors.email?.message} {...register("email")} />
        </div>
        <Input label="Contraseña *" type="password" icon={Lock} error={errors.password?.message} {...register("password")} />
        <Input label="Teléfono de contacto" type="number" icon={Phone} error={errors.phone?.message} {...register("phone")} />
      </div>
    </div>
  );
}
