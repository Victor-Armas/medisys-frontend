    ...
    <Controller
      ...
      render={({ field }) => (
        <div className="space-y-4 animate-in fade-in slide-in-from-top-3">
          <p className="text-[11px] font-bold text-subtitulo uppercase tracking-wider">Selecciona el tipo de perfil</p>
                  ...
                  <div>
                    <p
                      className={cn(
                        ...
                        isActive ? "text-current" : "text-encabezado dark:text-white",
                      )}
                    >
                      {config.label}
                    </p>
                    <p className="text-[11.5px] text-subtitulo mt-1 leading-snug">{config.desc}</p>
                  </div>
                </button>
              );
            })}
