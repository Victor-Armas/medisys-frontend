...
import { toCreateDoctorPayload, toCreateUserPayload } from "@/features/users/adapters/user.mapper";
...
export function UserFormModal({ onClose }: Props) {
  ...
  return (
    <Dialog open={true} onOpenChange={(open) => !open && onClose()}>
      <DialogContent className={cn("p-0 max-w-2xl gap-0 overflow-hidden ")}>
        {/* Header */}
        <DialogHeader>
          <DialogTitle>Nuevo Usuario</DialogTitle>
          <DialogDescription>Registra personal médico o administrativo en MediSys</DialogDescription>
        </DialogHeader>
