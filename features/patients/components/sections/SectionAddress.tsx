    ...
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-2 gap-3">
        <div>
          <select
            ...
            className="w-full px-4 py-4 bg-bg-surface border border-border-default rounded-md text-sm"
          >
        ...
        <div className="relative">
          ...
          <div className="absolute right-3 top-1/2 -translate-y-1/2 flex items-center gap-1.5 pointer-events-none">
            {isLoading && <Loader2 size={14} className="animate-spin text-brand" />}
      ...
      <div className="relative group">
        ...
        {suggestion && !isLoading && (
          <div className="absolute left-4 top-[21px] text-sm text-gray-400 pointer-events-none flex items-center">
        ...
        {suggestion && (
          <span className="absolute right-3 top-[20px] text-[10px] text-gray-400 font-medium uppercase tracking-wider z-20">
            [Tab] o [➜]
          </span>
        )}
      </div>
